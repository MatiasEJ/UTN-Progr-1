...
//se presenta un programa que permite cargar un vector, ordenar su contenido de froma creciente,
...
//la notacion [] indica que se recibe un vector pero se omite el tamaño del mismo;
